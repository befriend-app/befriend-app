befriend.activities = {
    ...
    displayActivity: {
        ...
        getViewHtml(activity_data) {
            ...
            function getWho() {
                return '';
                let reviews_html = befriend.user.getReviewsHtml(activity.person);

                let match_type_html = '';

                if(activity.matching?.total_score >= activity.matching?.thresholds?.ultra) {
                    match_type_html = `<div class="tag match-type ultra">Ultra match</div>`
                } else if(activity.matching?.total_score >= activity.matching?.thresholds?.super) {
                ...
                return `<div class="who section">
                            ...
                            <div class="age-gender">
                                <div class="age">
                                    ...
                                    <div class="text">${activity.person.age}</div>
                                </div>
                                ...
                                <div class="gender">
                                    ...
                                    <div class="text">${activity.person.gender?.gender_name}</div>
                                </div>
                            </div>
                                
                            <div class="content">
                                <div class="name-image">
                                    <div class="name">${activity.person.first_name}</div>
                                    <div class="image" style="background-image: url(${activity.person.image_url})" data-image-url="${activity.person.image_url}"></div>
                                </div>
                                ...
                                <div class="reviews">
                                    ...
                                    <div class="count">${activity.person.reviews.count} review${activity.person.reviews.count !== 1 ? 's' : ''}</div>
                                    ${reviews_html}
                                </div>
                            </div>
                        </div>`;
        ...
        <div class="rating-price">
            ...
            return `<div class="activity">
                    ...
                    <div class="max-recipients">Temp holder</div>
