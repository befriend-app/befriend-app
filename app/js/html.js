                ...
                <div class="login-signup-wrapper">
                    <div class="container">
                        ...
                        <div class="screens-container">
                            ...
                            <div class="screen create-account-screen hidden" id="create-account-screen">
                                <button class="back-button" id="back-from-create-account">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="create-password" placeholder="Password (min. 6 characters)">
                                </div>
                    
                                <!-- Hidden fields to store email/phone -->
                                <input type="hidden" id="create-phone">
                                <input type="hidden" id="create-email">
                    
                                <button class="continue-button" id="create-account-btn">Create Account <span class="spinner"></span></button>
                            </div>
                            ...
                            <div class="screen verification-screen hidden" id="verification-screen">
                                ...
                                <div class="spam-message">If the message is not received in your inbox, please check your spam folder for the code.</div>
